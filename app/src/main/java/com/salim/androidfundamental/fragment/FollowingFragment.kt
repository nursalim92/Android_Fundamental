...
import com.salim.androidfundamental.model.FollowingViewModel


class FollowingFragment : Fragment(R.layout.frag_follow) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getDataFollowing().observe(viewLifecycleOwner) {
            if (it != null){
                adapter.setList(it)
                loading(false)
            }
